...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)  // DocumentationType.SWAGGER_2 固定的，代表swagger2
                ...
                // 扫描指定包下的接口，最为常用
                .apis(RequestHandlerSelectors.basePackage("space.kuikui"))
    ...
    private ApiInfo apiInfo() {
        ...
        Contact contact = new Contact(
                "魁魁", // 作者姓名
                "https://kuikui.space", // 作者网址
                "kui512420@163.com"); // 作者邮箱

        return new ApiInfoBuilder()
                .title("项目API") //  可以用来自定义API的主标题
                .description("项目SwaggerAPI管理") // 可以用来描述整体的API
                .termsOfServiceUrl("https://kuikui.space") // 用于定义服务的域名（跳转链接）
                .version("1.0") // 可以用来定义版本
                .license("Swagger-的使用教程")
                .licenseUrl("https://kuikui.space")
                .contact(contact)
                .build(); //
    }
}
